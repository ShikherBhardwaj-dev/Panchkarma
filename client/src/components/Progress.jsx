...
// This Progress view doubles as a patient-focused analytics page.
// For practitioners it shows a patient selector and allows editing the numeric progress (0-100).
const Progress = ({ patientProgress = [], feedbackData = [], user = null }) => {
  ...
  <div className="space-y-8">
      ...
      {/* Practitioner editing panel removed as per new workflow */}
    </div>
  );
};
